"""
Django settings for Helpwave project.
...
SECRET_KEY = 'django-insecure-8^sm)zeji3u^02+@32eig-!6n3!hhr2-thmcpd_)%8wv(wqt(t'
...
WSGI_APPLICATION = 'Helpwave.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': os.getenv('POSTGRES_DB', 'helpwave'),
